...
class Board{
  constructor(boardHeight){
    ...
    this.spaces = [
      ...
      // Left Side
      new Property(this.loc("L",9),this.height,"L","New York Avenue","orange",200,false),
      new Property(this.loc("L",8),this.height,"L","Tenessee Avenue","orange",180,false),
      new Property(this.loc("L",7),this.height,"L","Community Chest","blank",0,true),
      new Property(this.loc("L",6),this.height,"L","St. James Place","orange",180,false),
      new Property(this.loc("L",5),this.height,"L","Pennsylvania Railroad","blank",200,true),
      new Property(this.loc("L",4),this.height,"L","Virginia Avenue","pink",160,false),
      new Property(this.loc("L",3),this.height,"L","States Avenue","pink",140,false),
      new Property(this.loc("L",2),this.height,"L","Electric Company","blank",150,true),
      new Property(this.loc("L",1),this.height,"L","St. Charles Place","pink",140,false),
      //Right Side
      new Property(this.loc("R",1),this.height,"R","Pacific Avenue","green",300,false),
      new Property(this.loc("R",2),this.height,"R","North Carolina Avenue","green",300,false),
      new Property(this.loc("R",3),this.height,"R","Community Chest","blank",0,true),
      new Property(this.loc("R",4),this.height,"R","Pennsylvania Avenue","green",320,false),
      new Property(this.loc("R",5),this.height,"R","Short Line","blank",200,true),
      new Property(this.loc("R",6),this.height,"R","Chance","blank",0,true),
      new Property(this.loc("R",7),this.height,"R","Park Place","dark blue",350,false),
      new Property(this.loc("R",8),this.height,"R","Luxury Tax","blank",100,true),
      new Property(this.loc("R",9),this.height,"R","Boardwalk","dark blue",400,false),
      //Top
      new Property(this.loc("T",1),this.height,"T","Kentucky Avenue","red",220,false),
      new Property(this.loc("T",2),this.height,"T","Indiana Avenue","red",220,false),
      new Property(this.loc("T",3),this.height,"T","Chance","blank",0,true),
      new Property(this.loc("T",4),this.height,"T","Illinois Avenue","red",240,false),
      new Property(this.loc("T",5),this.height,"T","B 0 Railroad","blank",200,true),
      new Property(this.loc("T",6),this.height,"T","Atlantic Avenue","yellow",260,false),
      new Property(this.loc("T",7),this.height,"T","Ventor Avenue","yellow",260,false),
      new Property(this.loc("T",8),this.height,"T","Water Works","blank",150,true),
      new Property(this.loc("T",9),this.height,"T","Marvin Gardens","yellow",260,false),
      //Bottom
      new Property(this.loc("B",9),this.height,"B","Connecticut Avenue","light blue",120,false),
      new Property(this.loc("B",8),this.height,"B","Vermont Avenue","light blue",100,false),
      new Property(this.loc("B",7),this.height,"B","Chance","blank",0,true),
      new Property(this.loc("B",6),this.height,"B","Oriental Avenue","light blue",100,false),
      new Property(this.loc("B",5),this.height,"B","Reading Railroad","blank",200,true),
      new Property(this.loc("B",4),this.height,"B","Income Tax","blank",200,true),
      new Property(this.loc("B",3),this.height,"B","Baltic Avenue","brown",60,false),
      new Property(this.loc("B",2),this.height,"B","Community Chest","blank",0,true),
      new Property(this.loc("B",1),this.height,"B","Mediteranean Avenue","brown",60,false)
    ]
